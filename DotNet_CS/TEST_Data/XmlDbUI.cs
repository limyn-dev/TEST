...
/* CLASS C_XML_DB_UI */
public partial class C_XML_DB_UI : Form
{
   #region    ********** [ MEMBERS     ] ******************************************************************************
   //                                                                               -----------------------------------
   ...
   #region    ********** [ EVENTS      ] ******************************************************************************
   //                                                                               -----------------------------------
   void C_XML_DB_UILoad(object sender, EventArgs e)   {}
   ...
   public static void Main() {
      /*----------------------------------------------------------------------------*
       * Entry point (program start). Create an instance of class C_XML_DB_UI and    *
       * run it.                                                                    *
       *----------------------------------------------------------------------------*/      
      Application.EnableVisualStyles();
      Application.Run(new C_XML_DB_UI());
   }
   #endregion *********************************************************************************************************
}
