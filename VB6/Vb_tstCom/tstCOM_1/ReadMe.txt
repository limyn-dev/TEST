========================================================================
		ActiveX Control DLL : TSTCOM_1
========================================================================

ControlWizard has created this project for your TSTCOM_1 ActiveX Control
...
that make up your TSTCOM_1 ActiveX Control DLL.
...
TstCOM_1Ctl.h
	This file contains the declaration of the CTstCOM_1Ctrl C++ class.

TstCOM_1Ctl.cpp
	This file contains the implementation of the CTstCOM_1Ctrl C++ class.

TstCOM_1Ppg.h
	This file contains the declaration of the CTstCOM_1PropPage C++ class.

TstCOM_1Ppg.cpp
	This file contains the implementation of the CTstCOM_1PropPage C++ class.

TstCOM_1Ctl.bmp
	This file contains a bitmap that a container will use to represent the
	CTstCOM_1Ctrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file tstCOM_1.rc.
