...
/*======================================================================================================================
   Description:
      Extension de la class employé par l'ajout des données propres aux techiciens. Du fait que les techniciens sont
      facturables, cette class implémente les méthodes de l'interface I_Billing .
...
public class C_Technician extends C_Employee implements I_Billing
   ...
   public int getToolKitNumber()                         { return myToolKitNumber ;                                     }
    ...
    /* Implémentation de l'interface I_Billing
   -------------------------------------------------------------------------------------------------------------------*/
   ...
   private int    myToolKitNumber ; // numéro de caisse à outils
