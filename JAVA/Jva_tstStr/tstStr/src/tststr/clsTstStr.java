...
public class clsTstStr
  ...
  /*---------------------------------------------------------------------------
    Extration d'une sous chaine délimitée
  ===========================================================================*/
  ...
  public static void main(String[] args)
    ...
    try
      ...
      // Saisie de la chaine et des délimiteurs
      cout.flush() ;
      cout.print("Chaine: ") ;
      tstStr.setStr(cin.readLine()) ;
      cout.print("Premier délimiteur: ") ;
      tstStr.setCarDeb(cin.readLine().charAt(0)) ;
      cout.print("Dernier délimiteur: ") ;
      tstStr.setCarFin(cin.readLine().charAt(0)) ;

      // Affichage de la saisie
      cout.println( "Chaine            : "+tstStr.getStr() )  ;
      cout.println( "Caractère de début: "+tstStr.getCarDeb() )  ;
      cout.println( "Caractère de fin  : "+tstStr.getCarFin() )  ;
